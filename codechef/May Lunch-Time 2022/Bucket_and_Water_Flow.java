...
class Bucket_and_Water_Flow{
    ...
    private static class Solution {
        public void solveTestcase(int testNumber, InputReader sc, OutputWriter out) {
            ...
            int w = sc.nextInt(); //Alice has a bucket of water initially having
            int x = sc.nextInt(); // The maximum capacity
            int y = sc.nextInt(); //rate of water flowing into bucket
            int z = sc.nextInt(); //left the tap running
