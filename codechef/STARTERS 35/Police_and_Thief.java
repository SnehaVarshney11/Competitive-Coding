...
class Police_and_Thief{
    ...
    private static class Solution {
        public void solveTestcase(int testNumber, InputReader sc, OutputWriter out) {
            ...
            int x = sc.nextInt(); //The initial location of the policeman on the number line
            int y = sc.nextInt(); //The initial location of the thief on the number line
